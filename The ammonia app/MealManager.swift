...
@Observable class MealManager {
    var meals: [Meal] = [
        ...
        Meal(name: "Bak Kuh Teh", storedDate: dateFormatter.date(from: "28-04-2025")!, plannedDate: dateFormatter.date(from: "17-05-2025")!, expiryDate: dateFormatter.date(from: "14-05-2025")!, temperature: .lower, humidity: .higher), // Should be attention required
